...
@section('content')
    <!-- SubHeader =============================================== -->
    @php
        $restaurant=\App\RestaurantProfile::find(1);
        @endphp
            ...
            <div class="col-md-6">
                <div class="box_style_2" id="main_menu">
                    ...
                    <table class="table table-striped cart-list">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-1.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-2.jpg')}}" alt="thumb"></figure>
                                <h5>2. Fajitas</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-3.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-4.jpg')}}" alt="thumb"></figure>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-5.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-6.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-7.jpg')}}" alt="thumb"></figure>
                                <h5>7. Beef Taco</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-8.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-9.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-10.jpg')}}" alt="thumb"></figure>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-11.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-12.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-13.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-14.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-15.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-16.jpg')}}" alt="thumb"></figure>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-17.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-18.jpg')}}" alt="thumb"></figure>
                                <h5>18. Cheesecake</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-19.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-20.jpg')}}" alt="thumb"></figure>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-21.jpg')}}" alt="thumb"></figure>
                                <h5>21. Coke 0.33L</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-22.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-23.jpg')}}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{{asset('landing/img/menu-thumb-24.jpg')}}" alt="thumb"></figure>
            ...
            <div class="col-md-3" id="sidebar">
                <div class="theiaStickySidebar">
                    <div id="cart_box" >
                        ...
                        <hr>
                        <a class="btn_full" href="{{route('cart1')}}">Order now</a>
                    </div><!-- End cart_box -->
