...
@section('content')
    <!-- SubHeader =============================================== -->
    <section class="parallax-window" id="short" data-parallax="scroll" data-image-src="{{asset('landing/img/sub_header_cart.jpg')}}" data-natural-width="1400" data-natural-height="350">
        <div id="subheader">
            <div id="sub_content">
                <h1>About us</h1>
    ...
    <div class="container margin_60_35">
        <div class="row">
            ...
            <div class="col-md-7 col-md-offset-1 text-right hidden-sm hidden-xs">
                <img src="{{asset('landing/img/devices.jpg')}}" alt="" class="img-responsive">
            </div>
        </div><!-- End row -->
