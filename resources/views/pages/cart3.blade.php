            ...
            <div id="sub_content">
                ...
                <div class="bs-wizard">
                    <div class="col-xs-4 bs-wizard-step complete">
                        ...
                        <a href="{{route('cart1')}}" class="bs-wizard-dot"></a>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-6">
                                        <img src="{{asset('landing/img/icon_ccv.gif')}}" width="50" height="29" alt="ccv"><small>Last 3 digits</small>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-3" id="sidebar">
                <div class="theiaStickySidebar">
                    <div id="cart_box">
                        ...
                        <hr>
                        <a class="btn_full" href="{{route('cart3')}}">Confirm your order</a>
                    </div><!-- End cart_box -->
