...
<section class="content home">
    ...
    $farmers_count = FarmerProfile::get();
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                <div class="body">
                                    <h2 class="number count-to m-t-0 m-b-5" data-from="0" data-to="123" data-speed="1000" data-fresh-interval="700">120</h2>


                                    <p class="text-muted">Todays Farmers </p>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                ...
                                <div class="body">
                                    ...
                                    <h2 class="number count-to m-t-0 m-b-5" data-from="0" data-to="33" data-speed="2000" data-fresh-interval="700">3</h2>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                <div class="body">
                                    <h2 class="number count-to m-t-0 m-b-5" data-from="0" data-to="233" data-speed="2000" data-fresh-interval="700"></h2>
                                    <p class="text-muted">Total Kgs</p>
