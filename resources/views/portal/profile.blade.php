                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-12">
                                    ...
                                    <span class="job_post">{{$user->headline}}</span>
                                    <p>{{$user->location}}</p>
                                    <div class="">
                                        <a class="text-dark" href="tel:{{$user->phone}}"><i
                                                class="zmdi zmdi-phone mr-1"></i> {{$user->phone}}</a><br>
                                        <a class="text-dark" href="mailto:{{$user->email}}"><i
                                                class="zmdi zmdi-email mr-1"></i> {{$user->email}}</a>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    <form class="row clearfix" action="{{route('profile.update')}}" method="post"
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Name"
                                                       name="title" value="{{$user->title??old('title')}}">
                                                @error('title')
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Headline"
                                                       name="headline" value="{{$user->headline??old('headline')}}">
                                                @error('headline')
                                                <span class="small pl-3 text-danger font-weight-light" role="alert">
                                                        <strong>{{$message}}.</strong>
                                                </span>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="location"
                                                       name="location" value="{{$user->location??old('location')}}">
                                                @error('location')
                                                <span class="small pl-3 text-danger font-weight-light" role="alert">
                                                        <strong>{{$message}}.</strong>
                                                </span>
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Website" value="{{$user->website}}" name="website">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" value="{{$user->email}}" placeholder="E-mail" name="email">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" value="{{$user->postal_address}}" placeholder="Address" name="postal_address">
                                            </div>
                                        </div>
                                        <div class=" col-md-12">
                                            <div class="form-group">
