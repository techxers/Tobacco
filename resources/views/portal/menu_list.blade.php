                    ...
                    <div class="body table-responsive">
                        <table class="table table-hover m-b-0">
                            ...
                            @if(null !==($restaurant))
                                ...
                                <tr>
                                    <td><img src="{{asset($menu->image)}}" width="48" alt="Item image"></td>
                                    <td>
                                        <h5>{{$menu->title}}</h5>
                                    </td>
                                    ...
                                    <!-- <a class="dropdown-item"  id="action-approve"><i class="feather icon-check"></i>Approve</a> -->
                                    ...
                                    <td>
                                        ...
                                        <a span  data-toggle="modal" data-target="#deleteModal" class="btn btn-default waves-effect waves-float waves-red"><i class="zmdi zmdi-delete"></i></span>
                                    </td>
                                    <td></td>
                                </tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="deleteModalLabel"> Delete  {{$menu->title ?? 'No Menu'}} </h4>
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('menu.remove')}}" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    @method('POST')
                <div class="col-12 col-md-6">
                    ...
                    <div class="col-12">
                            <button type="reset" onclick="$('#deleteModal').hide()" class="btn btn-danger ">
                                Cancel
                            </button>
                            <button type="submit"
