                        ...
                        <table class="table table-hover m-b-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{$tobacco->description ?? 'No  description'}}
                                    </td>
                ...
                <form method="post" action="{{route('tobbaco.add')}}" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Tobacco Name" name="name">
                            @error('name')
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Tobacco Description" name="description">
                            @error('description')
                            <span class="small pl-3 text-danger font-weight-light" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
