                        ...
                        <table class="table table-hover m-b-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Unit Name</th>
                                    <th data-breakpoints="xs md">Unit Type</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5>{{$Unit->unit_name ?? 'No unit_name'}} </h5>
                                    </td>
                                    <td>{{$Unit->measure ?? 'No measure'}}</td>


                                </tr>
                                @endforeach
                                @else
                                <h1>No units Availabe</h1>
                                @endif
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="menuAddModalLabel">Add Unit</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('measure.add')}}" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    @method('POST')
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Type of measure" name="measure">
                            @error('measure')
                            <span class="small pl-3 text-danger font-weight-light" role="alert">
                                <strong>{{$message}}.</strong>
                            </span>
