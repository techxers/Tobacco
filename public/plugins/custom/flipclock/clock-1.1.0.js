(function($){
    var Clock = function(){
        ...
        // themes
        _.ts = {
            't1': ['#ffffff', '#004b79', '#a2aca4', '#fbf5e2', '#666'],
            't2': ['#ffdabf', '#576069', '#1c655b', '#f3f4f6', '#fff1e7'],
            't3': ['#44a2a2','#123555','#d1494e','#ffefe4','#e69b03']
        };
        ...
        _.paintPs = function(context){
            ...
            context.font = .3*_.iw+"px YaHei";
            context.fillStyle = '#000';
            context.lineWidth = .08*_.iw;
