...
$.AdminOreo = {}, $.AdminOreo.options = {
    ...
    activate: function () {
        ...
        var a = $("body"), t = $(".navbar .navbar-header .bars"), i = a.width();
    ...
    activate: function () {
        var t = this, i = $("#rightsidebar"), r = $(".overlay");
        $(window).on("click", function (e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("js-right-sidebar") && t.isOpen() && 0 === a.parents("#rightsidebar").length && (a.hasClass("bars") || r.fadeOut(), i.removeClass("open"))
